...
This buildpack works in conjuction with [ATK's heroku-buildpack-multi](https://github.com/Americastestkitchen/heroku-buildpack-multi) buildpack.

heroku-buildpack-multi loads on your app's buildpacks that are specified inside its .buildpacks file, such as https://github.com/Americastestkitchen/heroku-buildpack-apt and https://github.com/Americastestkitchen/heroku-wordpress-php as in the [ATK's Feed app](https://github.com/Americastestkitchen/feed)

I removed the original test folder which contained Aptfile & .buildpacks files to avoid confusion about how and where they are used as they are located on app's code base in the root of the project folder: see them in [ATK's Feed app](https://github.com/Americastestkitchen/feed)

---
## Original examples

The following is from original repo instructions from [ddollar/heroku-buildpack-apt](https://github.com/ddollar/heroku-buildpack-apt). KEEP IN MIND that they had originally included samples of test/Aptfile & test/.buildpacks just for explanatory purposes which do not actually operate from within THIS buildpack's codebase, ie you still need an app that calls on this buildpack to install dependencies.
